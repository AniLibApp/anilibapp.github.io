export function TermsAndCondition() {
  return (
    <div class="p-5">
      ...
      <p>
        rev0lgenX is committed to ensuring that the app is as useful and
      ...
      <p>
        The AniLib app stores and processes personal data that you have provided
        ...
        features and it could mean that the AniLib app won’t work properly or at
        all.
      </p>
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that rev0lgenX will
        ...
        Wi-Fi, or provided by your mobile network provider, but rev0lgenX cannot
      ...
      <p>
        Along the same lines, rev0lgenX cannot always take responsibility for
        ...
        avail the Service, rev0lgenX cannot accept responsibility.
      </p>
      <p>
        With respect to rev0lgenX’s responsibility for your use of the app, when
        ...
        it available to you. rev0lgenX accepts no liability for any loss, direct
      ...
      <p>
        ...
        using the app. rev0lgenX does not promise that it will always update the
        app so that it is relevant to you and/or works with the Android version
      ...
      <p>These terms and conditions are effective as of 2021-01-31</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at anilib.dev@gmail.com.
      </p>
      <p>
